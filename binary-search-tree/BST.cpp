...
template <typename T>
inline bool BST<T>::isEmpty() const { return root == nullptr; }
...
// returns: nothing
template <typename T>
inline void BST<T>::breadthFirst(const callback &visit)
{
...
// returns: nothing
template <typename T>
inline void BST<T>::inorder(const callback &visit)
{
...
// returns: nothing
template <typename T>
inline void BST<T>::preorder(const callback &visit)
{
...
// returns: nothing
template <typename T>
inline void BST<T>::postorder(const callback &visit)
{
...
// returns: nothing
template <typename T>
inline void BST<T>::inorderUtil(const callback &visit, Node *node)
{
...
// returns: nothing
template <typename T>
inline void BST<T>::preorderUtil(const callback &visit, Node *node)
{
    if (node != nullptr) // base case
    {
        visit(node);
...
// returns: nothing
template <typename T>
inline void BST<T>::postorderUtil(const callback &visit, Node *node)
{
    if (node != nullptr) // base case
    {
...
// returns: nothing
template <typename T>
BSTNode<T> *BST<T>::insertUtil(const T &data, Node *node)
{
    if (node == nullptr)       // leaf node?
        return new Node(data); // insert a new node
...
// returns: nothing
template <typename T>
inline BSTNode<T> *BST<T>::deleteNodeUtil(const T &data, Node *node)
{
    if (node == nullptr)
        return nullptr;
    ...
    if (node->data == data)
    {
        ...
        else if (node->hasTwoChild())
        {
            ...
            node->data = succ->data;
            succ->data = data;
            deleteNodeUtil(data, root);
        }
        return ret;
    }
    // if (node == nullptr)
    node->left = deleteNodeUtil(data, node->left);
    node->right = deleteNodeUtil(data, node->right);
    return ret;
}
